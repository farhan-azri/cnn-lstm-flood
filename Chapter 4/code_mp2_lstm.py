...
# ============================================================
# 🤖 6️⃣B MODEL DEFINITION — PURE LSTM
# ============================================================
from tensorflow.keras.models import Sequential
...
model_lstm = Sequential([
    ...
    Dropout(0.3),
    LSTM(32, return_sequences=False), # Second LSTM to process the sequence output of the first
    Dropout(0.3),
...
print("\n🧾 Classification Report (Pure LSTM):")
