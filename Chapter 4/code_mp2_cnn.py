...
# ============================================================
# 🤖 6️⃣A MODEL DEFINITION — PURE CNN
# ============================================================
from tensorflow.keras.models import Sequential
...
model_cnn = Sequential([
    ...
    MaxPooling1D(2),
    Conv1D(128, kernel_size=2, activation='relu'), # Second Conv layer to extract deeper features
    GlobalAveragePooling1D(), # Flattens the sequence data for the Dense layers
    Dropout(0.3),
...
# ============================================================
# 8️⃣A EVALUATION — PURE CNN
# ============================================================
y_prob_cnn = model_cnn.predict(X_test)
y_pred_cnn = (y_prob_cnn > 0.3).astype(int)

print("\n📊 Final Model Performance (Pure CNN):")
