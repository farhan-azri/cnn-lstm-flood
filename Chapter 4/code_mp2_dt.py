...
# ============================================================
# 🤖 6️⃣D MODEL DEFINITION — DECISION TREE
# ============================================================
...
print(f"Flattened X_train_dt shape (2D): {X_train_dt.shape}")

# Initialize Decision Tree
# We restrict max_depth to prevent the tree from overfitting the training data too heavily
...
# ============================================================
# 8️⃣D EVALUATION — DECISION TREE
# ============================================================

# Get probability predictions for the test set
# predict_proba returns an array of shape (n_samples, n_classes), we want the probabilities for class 1 (Flood)
y_prob_dt = model_dt.predict_proba(X_test_dt)[:, 1]

# Apply the 0.3 threshold to favor recall (catching more potential floods)
y_pred_dt = (y_prob_dt > 0.3).astype(int)

print("\n📊 Final Model Performance (Decision Tree, threshold=0.3):")
