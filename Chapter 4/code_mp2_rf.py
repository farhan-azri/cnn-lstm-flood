...
# ============================================================
# 🤖 6️⃣C MODEL DEFINITION — RANDOM FOREST
# ============================================================
from sklearn.ensemble import RandomForestClassifier
from sklearn.metrics import accuracy_score, precision_score, recall_score, f1_score, classification_report

# Flatten the 3D sequences (samples, timesteps, features) into 2D (samples, timesteps * features)
# This is required because Random Forest expects 2D tabular arrays, not 3D sequences.
X_train_rf = X_train.reshape(X_train.shape[0], -1)
X_val_rf = X_val.reshape(X_val.shape[0], -1)
X_test_rf = X_test.reshape(X_test.shape[0], -1)

print("\n--- RANDOM FOREST SETUP ---")
print(f"Original X_train shape (3D): {X_train.shape}")
print(f"Flattened X_train_rf shape (2D): {X_train_rf.shape}")

# Initialize Random Forest
# class_weight='balanced' automatically handles the flood class imbalance 
...
# ============================================================
# 7️⃣C TRAINING — RANDOM FOREST
# ============================================================
print("\n🚀 Training Random Forest...")

# Note: Random Forest doesn't use early stopping with a validation set in the same way neural networks do. 
# You can actually combine train and val sets for RF, but we'll stick to your X_train to keep the test comparisons fair.
model_rf.fit(X_train_rf, y_train)

print("✅ Training complete.")

# ============================================================
# 8️⃣C EVALUATION — RANDOM FOREST
# ============================================================

# Get probability predictions for the test set (predict_proba returns [prob_class_0, prob_class_1])
y_prob_rf = model_rf.predict_proba(X_test_rf)[:, 1]

# Apply the same 0.3 threshold you used in the neural network to favor recall
y_pred_rf = (y_prob_rf > 0.3).astype(int)

print("\n📊 Final Model Performance (Random Forest, threshold=0.3):")
